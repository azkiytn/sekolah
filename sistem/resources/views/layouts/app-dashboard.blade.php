            ...
            <div class="col-md-2" style="margin-left: -130px;">
                <div class="sidebar">
                    <ul class="menu-content">
                        <img src="sistem/img/logo.png" alt="sekolah" style="width: 70px;" class="d-inline-block align-text-center" />
                        <a style="margin-top: 30px;" href="{{url('/home')}}"><i class="fa fa-home"></i> Dashboard</a>
                        <hr class="menu-separator">
                        <a href=""><i class="fas fa-school"></i> Profil Sekolah</a>
                        <hr class="menu-separator">
                        <a href="{{url('/')}}"><i class="far fa-newspaper"></i> Berita</a>
                        <hr class="menu-separator">
                        <a href=""><i class="fas fa-users"></i> Pengguna</a>
                        <hr class="menu-separator">
                        <a href="{{url('/guru')}}"><i class="fas fa-chalkboard-teacher"></i> Data Guru</a>
                        <hr class="menu-separator">
                        <a href="{{url('/kelas')}}"><i class="far fa-building"></i> Data Kelas</a>
                        <hr class="menu-separator">
                        <a href="{{url('/mapel')}}"><i class="far fa-file-alt"></i> Data Mapel</a>
                        <hr class="menu-separator">
                        <a href="{{url('/jadwal')}}"><i class="far fa-calendar-alt"></i> Jadwal Mengajar</a>
                        <hr class="menu-separator">
                        <a href="{{url('/siswa')}}"><i class="far fa-address-book"></i> Data Siswa</a>
                        <hr class="menu-separator">
                        <a href="{{url('/nilai')}}"><i class="far fa-file-alt"></i> Data Nilai</a>
                        <hr class="menu-separator">
                        <a href="{{url('/presensi')}}"><i class="far fa-calendar-check"></i> Presensi Siswa</a>
                        <hr class="menu-separator">
                    </ul>
                </div>
            </div>
            <div class="col" style="margin: 5px -110px 0 30px;">
                <nav class="navbar navbar-expand-md bg-body-tertiary shadow p-3 mb-5 rounded" style="background-color: #135E69;">
