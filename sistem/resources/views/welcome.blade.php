...
<div class="container">
    <div class="row">
        <div class="col" style="background-color: #135E69;">
            <div class="horizontal-line">
...
<div class="container" style="margin-top: 100px;">
    <div class="row">
        ...
        <div class="col" style="margin: 18px 0 0 -70px;">
            <div class="garis-warna">
            </div>
        </div>
    </div>
...
<div class="card-container">
    <div class="card">
        <img class="card-img-top" src="sistem\img\Berita1.jpeg" alt="Card image cap">
        <div class="card-body">
            <h4 class="card-title" style="color: #135E69; font-weight: bold;">Pengenalan & Pelatihan Teknologi</h4>
    ...
    <div class="card">
        <img class="card-img-top" src="sistem\img\Berita2.jpeg" alt="Card image cap">
        <div class="card-body">
            <h4 class="card-title" style="color: #135E69; font-weight: bold;">Pelaksanaan ASAJ</h4>
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
            <a href="#" class="btn btn-primary">Baca selengkapnya...</a>
        </div>
    ...
    <div class="card">
        <img class="card-img-top" src="sistem\img\Berita3.jpeg" alt="Card image cap">
        <div class="card-body">
            <h4 class="card-title" style="color: #135E69; font-weight: bold;">Pesantren Ramadhan</h4>
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
            <a href="#" class="btn btn-primary">Baca selengkapnya...</a>
        </div>
    ...
    <div class="card">
        <img class="card-img-top" src="sistem\img\Berita4.jpeg" alt="Card image cap">
        <div class="card-body">
            <h4 class="card-title" style="color: #135E69; font-weight: bold;">Pelaksanaan Postest AKM Kelas</h4>
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
            <a href="#" class="btn btn-primary">Baca selengkapnya...</a>
        </div>
